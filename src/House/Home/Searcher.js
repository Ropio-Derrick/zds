...
function Searcher() {
  return (
    <div className='  mb-16 rounded-2xl gap-4 relative mt-[-100px] text-[#519e51] mx-[100px] md:mx-[100px]  z-30  xs:mx-4 grid grid-cols-4 lg:grid-cols-4 md:grid-cols-2 xs:grid-cols-1  items-center width-full ' >
