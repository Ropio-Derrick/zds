...
function Searcher() {
  return (
    <div className='  mb-16 rounded-2xl gap-4 relative mt-[-100px] md:mt-[-100px] sm:mt-[-40px] mt-[-40px]  text-[#519e51] mx-[100px] md:mx-[100px]  z-30  xs:mx-4 grid grid-cols-4 lg:grid-cols-4 md:grid-cols-2 xs:grid-cols-1  items-center width-full ' >
        <div className='flex justify-center items-center  shadow-2xl shadow-black  h-[200px] md:h-[200px] sm:h-[160px] xs:h-[160px]     rounded-2xl bg-white flex flex-1 flex-col items-left justify-start'>
        ...
        <div className='flex justify-center items-center shadow-2xl shadow-black    h-[200px] md:h-[200px] sm:h-[160px] xs:h-[160px]    bg-white flex flex-1 flex-col rounded-2xl items-left justify-start'>
        ...
        <div className='flex justify-center items-center shadow-2xl shadow-black   h-[200px] md:h-[200px] sm:h-[160px] xs:h-[160px]   bg-white flex flex-1 flex-col items-left rounded-2xl justify-start'>
